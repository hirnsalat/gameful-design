...
![Scans of m0ru's sketchbook]({{site.mediaurl}}/{{page.media_dir}}/sketchbook.png)
...
![Photo of whiteboard during initial brainstorming]({{site.mediaurl}}/{{page.media_dir}}/brainstorming_whiteboard.png)
...
![Whiteboard-picture created while refining "Pillow Fight"]({{site.mediaurl}}/{{page.media_dir}}/final_whiteboard.png)
...
![Movement illustration/examples]({{site.mediaurl}}/{{page.media_dir}}/movement.svg)
...
![Taking cover at behind a wall - being attacked - - illustration]({{site.mediaurl}}/{{page.media_dir}}/cover_edge.svg)
![Taking cover at a corner of a wall - being attacked - illustration]({{site.mediaurl}}/{{page.media_dir}}/cover_corner.svg)

![Throwing around corner - Illustration]({{site.mediaurl}}/{{page.media_dir}}/cover_corner_reverse.svg)
![Throwing along wall - Illustration]({{site.mediaurl}}/{{page.media_dir}}/cover_along_wall.svg)
...
![Board during Early Game]({{site.mediaurl}}/{{page.media_dir}}/early_game.jpg)
...
![Board during Late Game]({{site.mediaurl}}/{{page.media_dir}}/late_game.jpg)
